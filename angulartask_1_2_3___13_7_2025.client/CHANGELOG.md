...
- Create Angular project with ng: `ng new angulartask_1_2_3___13_7_2025.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angulartask_1_2_3___13_7_2025.client.esproj`).
